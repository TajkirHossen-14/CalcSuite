 ...
 */
// Bump this whenever a shell file changes. The activate handler deletes every
// cache that is not the current name, which is what forces an already-installed
// copy to pick up a new logo or stylesheet instead of serving the old one.
const CACHE = 'calcsuite-v2';
const SHELL = [
  './',
  './index.html',
  './manifest.json',
  ...
  './Assets/Favicon/icon-maskable.svg'
];
